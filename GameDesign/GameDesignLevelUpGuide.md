...
- 진심으로, 그대의 플레이어를 사랑할지어다
    - 플레이어의 죽음을 게임 설계의 척도로 삼으면 '절대' 안 된다.
...
- 레벨 구축하기
    ...
    - 조명
    - 소리
> - 처음부터 멀티플레이어 시스템을 게임에 포함해 설계한다
> - 플레이어에게 다양한 게임 모드와 목표를 제공한다
> - 적절한 플레이어 수는 게임플레이에 따라 결정된다
> - 플레이어들이 각자의 개성에 따라 캐릭터, 오브젝트, 세계를 커스터마이즈 할 수 있게 한다
> - 플레이어에게 제작 도구를 주면 새로운 플레이 패턴이 탄생한다
> - 플레이어끼리 어떤 레벨에서 부정적인 상호작용을 할 수 있는지 결정한다
> - 플레이어는 절대 여러분의 예상대로 움직이지 않지만, 때로는 그런 것도 괜찮다
> - 멀티플레이어 레벨은 싱글플레이어 레벨처럼 설계하면 안 된다.

## Level 15 - 모두가 행복해지는 길 : 수익화
> 버드, 돈이라는 건 말이야, 네가 하기 싫은 일을 하게 만드는 거야. -윌 스트리트-
- 수익화
    - 유료 플레이
    - 게임 내 광고
    - 가상 아이템
    - 다운로드 가능 컨텐츠(DLC)
    - 섣부른 수익화는 멸망의 길로 인도한다.
- 비즈니스 모델
    - 트라이얼
    - 부분 유료화
    - 프리투플레이
...
- 받은만큼 돌려주자
    ...
    - 진행
- 돈은 무언가 특별한 것의 근원이다.
    - 화폐 혼동 : 플레이어가 직접 획득하는 게임 내 화폐와 실제 돈을 지불하고 콘텐츠를 구입할 때 사용하는 화폐는 따로 구분되어야 한다.
    - 번들 : 아이템을 번들로 판매하면 플레이어는 알차게 소비를 하는 듯한 느낌을 받는다.
    - 난이도 조절 : 플레이어가 부스터를 사야 게임이 진행되도록 난이도를 높인다.
    - 유쾌한 고통 : 플레이어에게 즐거움과 고통을 모두 선사해야한다.
    - 보상 제거하기 : 플레이어에게 결제하지 않으면 보상이 사라진다고 위협한다.
    - 물론 이러한 것은 플레이어가 이용당한다는 기분을 받을 수 있다.
- 도덕적으로 수익화하기
    - 대안을 제시한다
    - 플레이어에게 유료라고 경고한다
    - 할인가를 제시한다
    - 플레이어에게 무를 기회를 준다.
> - 게임에서 수익화가 어느 정도 비중을 차지할 지 정한다.
> - 처음부터 수익화 체계를 게임 디자인에 포함시킨다.
> - 강압적 수익화의 힘을 간과하지 말자
> - 도덕적인 수익화 체계를 설계하자.

## Level 16 - 음악 이야기
- 보통 음악은 제작 단계 후반까지 미뤄지기 일쑤이지만 이것은 실수이다. 음악은 게임에 지대한 영향을 미치기 때문에, 마지막까지 미루다 보면 디자인을 개선할 좋은 기회를 놓치기 쉽다.
- 라이선스 음악 : 기존에 녹음된 음악을 사용하고 비용을 지불한다.
- 오리지널 뮤직 : 직접 음악을 만든다.
- 음악 용어
    - 악센트, 비트, 코드, 악기, 무드, 옥타브, 음정, 리듬, 템포, 테마, 음조, 업비트, 음량
- 사용료를 내지 않은 음악을 게임에 남겨두는 실수를 저지르지 말자!
- 배경음악은 몇 분 정도의 길이로 제작해 반복해야한다.
- 테마
    - 미스터리, 경고, 전투, 추격/빠른 이동, 승리, 걷기
- 효과음
    - 움직임, 공격, 충격, 무기, 히트 반응, 음성, 죽음, 성공
    - 현실적? 만화적?
    - 분위기에 맞춰서
    - 타이밍을 잘 생각하자.
    - 근거리, 원거리, 우선순위 효과음
> - 게임 제작 초기에 어떤 음향이 필요한지 파악해둔다. 후반부까지 미루지 말자
> - 음악 관련 용어를 배워 작곡가에게 원하는 바를 정확하게 전달하자
> - 효과음과 목소리를 활용해서 게임의 중요한 진행 상황을 전달하자
> - 사용 권한이 없는 음악이나 소리는 사용하지 않는다
> - 음악을 활용해 게임 속 행동을 이끈다
> - 라이트모티프를 반복 재생해 스토리 전달을 위한 분위기를 조성한다
> - 음악과 소리의 타이밍과 거리감을 잘 조정해, 게임에 현실감을 더하고 상호작용이 자연스럽게 일어나게 한다
> - 묵음이 어떤 음악보다도 강력한 효과를 내기도 한다.
> - 음악과 효과음을 게임플레이에 호라용하자.

## Level 17- 컷씬, 누가 볼까 싶지만 그래도
- 컷씬은 스토리를 전개하고, 장관을 연출하며, 분위기를 조성하고, 대화를 보여주며, 캐릭터를 표현하기 위한 애니메이션 또는 라이브액션 시퀀스이다.
- 컷씬은 환상적인 영상과 함께 게임 엔진으로는 구현할 수 없는 방식으로 게임 세계를 보여주지만 너무 길고, 스토리 전개에 불필요하며, 보기가 귀찮기도 하다.
> 게임플레이에서 이 액션을 할 수 있는가?
- 컷씬은 제작 비용이 많이 든다
    - 모든 요소를 직접 통제하여 더 다양한 감정 표현
    - 프리렌더링한 영상에 비해 만남의 장면을 생생하게 표현하기 어렵다
    - 화면을 통제할 수 없을 때 스토리에 몰입하기 쉽다
    - 프리렌더링 영상에서는 폭발 장면을 환상적으로 표현할 수 없다.
- 만드는 방법
    - 풀모션 영상
    - 애니메이션 또는 풀모션 애니메이션
    - 플래시 애니메이션 시퀀스
...
- 각본쓰기 8단계
    1. 스토리의 얼개를 짠다.
    2. 스토리를 장면별로 나누고, 각 장면마다 어느 캐릭터가 등장할 지 결정
    3. 스토리 중 어느 장면을 컷신으로 보여주고 어느 장면을 게임플레이로 전개할 지 결정
    4. 장면과 대화를 작성
    5. 정식 시나리오 형식에 맞춰서 각본을 쓴다.
    6. 작성한 각본을 읽어보자
    7. 하루 이틀 정도 기다려본다.
    8. 스프레드시트같은 것을 사용해 성우들을 위한 대본을 만든다.
> - 컷신은 게임스타일,예산,일정과 맞아야한다
> - 기본적인 각본 형식에 맞춰 각본을 쓰자
> - 보는 이의 시선을 끌기 위해서는 짜릿한 장면으로 게임을 시작해야 한다
> - 플레이어에게 구경만 시키지 말고 직접 체험하게 하자. 게임플레이를 활용해 스토리를 전달한다.
> - 플레이어가 컷신을 건너뛸 수 있게 하고, 같은 장면을 계속 보게 만들지 않는다.
> - 컷신의 길이를 짧게 유지해 플레이어의 시간과 여러분의 예산을 절약한다.
> - 키스와 폭파 장면에는 컷신을 활용한다. 컷신은 화려하고 장대한 순간과 로맨스 순간을 위해 아껴두나. 나머지는 게임플레이를 통해 보여준다.
> - 전문 성우의 연기가 큰 차이를 만든다. 되도록 성우를 활용하자
> - 녹음을 준비할 때에는 성우들이 참고할 자료를 준비한다.

## Level 18 - 이제 어려운 이야기를 해보자.
- 게임을 만들기 전에 퍼블리싱할 회사부터 찾아야 할지도 모른다.
- 누군가 돈을 투자하도록 설득하려면 pitch가 필요하다.
    - 게임 디자인 문서를 간결하고 이해하기 쉽게 다듬은 버전.
    - 게임의 장점과 독창성을 아낌없이 보여주되, 장황하게 설명을 늘어놓아서는 안 된다.
- 내용
    - 로고가 들어간 타이틀 화면
    - 회사 프로필
    - 하이 컨셉
...
- 돈은 누가 낼까?
    ...
    - 전통 퍼블리셔
- 비디오게임은 사람이 만든다.
    - 콘텐츠를 지나치게 많이 계획하지 말고, 팀원들이 소화할 수 있는 범위 이상의 일을 벌이지 않는다.
    - 미리 계획을 세우자. 팀원들의 휴가나 병가에 대비하자
    - 디자인과 콘텐츠를 최대한 빨리 확정한다.
    - 플레이어는 언제나 게임을 망가뜨릴 궁리를 한다.
    - 민감한 문화적 차이에 유의하자
    - 눈먼 디자이너가 되지 않도록 주의하자.
        - 스스로가 게임을 처음 해본다고 생각하자
        - 멀찌감치 떨어져서 객관적인 시선으로 게임을 바라보자
        - 게임을 다운시켜보자. 평소와 다르게 플레이를 해보자
        - 다른 게임과 비교해본다.
        - 게임 스토리를 말해본다.
        - 매 제작 단계에서 반복 점검을 한다.
        - 다른 사람들의 피드백을 듣는다.
        - 포커스 그룹을 활용한다. 특정 목적을 위해 게임을 플레이하도록!
        - 안 좋은 부분이 있다면 없애자.
    - 크런치타임을 피하자
        - 일정을 짜자
        - 힘든 일을 먼저 하자
...
- 속편은 무엇을 하는 것이 좋을까?
    - 전작의 실수를 만회하자
    - 원작 게임의 뼈대를 속편 게임플레이 디자인의 기본으로 삼는다.
    - 좋았던 부분은 유지,개선하고 그렇지 않은 부분은 전부 없앤다.
    - 플레이어를 실망시키지 말자.
    - 게임 이름을 잘 생각해보자.
    - 새로운 무언가를 제시하자.(너무 새롭지는 않게..)
> - 데모>GDD>피치 프레젠테이션>피치
> - 적절한 대상에게 피치하자
> - 기술적 문제에 대비하자
> - 어떤 질문이 들어와도 대답할 수 있도록 자신이 만들 게임을 완벽하게 이해하자
> - 다른 사람 앞에서 피치를 연습하자
> - 비디오게임은 사람이 만든다. 좋은 일이든 나쁜 일이든 인생사를 고려해 일정을 짜자
> - 눈 먼 디자이너가 되지 말자
> - 수평 레이어나 수직 조각 방식으로 게임을 제작하자. 하나를 골라서 밀어붙이자
> - 게임에서 안 좋은 부분은 잘라내되, 이런 일이 생기지 않도록 미리 철저하게 계획을 세운다.
> - 책임감 있게 디자인 목표를 설정하고 제작 일정을 상세하게 계획해서 크런치 타임을 방지한다.
> - 창발적 게임플레이로 게임의 재미가 생기기를 기대하지 말자. 좋은 디자인은 미리 계획되어 나온다.
> - 속편을 만들 때에는 3 대 7의 비율을 기억하자. 전작에서 재미있었던 요소는 모두 유지하고, 안 좋았던 부분은 전부 뺀다.
> - 전작을 재탕하지 말자. 전작에서 무엇을 개선할 수 있을지 냉정하게 판단한다.
> - 플레이어를 실망시키지 말자.
